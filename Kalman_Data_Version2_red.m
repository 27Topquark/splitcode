%KALMAN DATA CREATOR version 2.0
...
%THIS VERSION WORKS FOR RED FEET ONLY
...
first_frame_tag = input('First frame tag 1 for front foot and 2 for hind') ;%one for front and 2 for hind required if both feet are not captured
%in the first frame
